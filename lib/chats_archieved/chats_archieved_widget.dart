...
import 'chats_archieved_model.dart';
export 'chats_archieved_model.dart';

class ChatsArchievedWidget extends StatefulWidget {
  const ChatsArchievedWidget({Key? key}) : super(key: key);

  @override
  _ChatsArchievedWidgetState createState() => _ChatsArchievedWidgetState();
}

class _ChatsArchievedWidgetState extends State<ChatsArchievedWidget>
    with TickerProviderStateMixin {
  late ChatsArchievedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatsArchievedModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ChatsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatsRecord> chatsArchievedChatsRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final ordersChats = chatsArchievedChatsRecordList
                                .map((e) => e)
                                .toList()
                                .where((e) =>
                            ...
                            if (ordersChats.isEmpty) {
                              return EmptyChatsWidget(
                                firstString:
                                    'Nenhum chat de reserva está arquivado',
                                secondString:
                                    'Ao arquivar chats de reservas eles aparecerão aquia',
                              );
                            }
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 0.0, 0.0),
                                                                                child: Text(
                                                                                  columnAdsRecord.price.toString(),
                                                                                  style: FlutterFlowTheme.of(context).labelMedium.override(
                                                                                        fontFamily: 'Outfit',
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final vendasChats = chatsArchievedChatsRecordList
                                .map((e) => e)
                                .toList()
                                .where((e) =>
                            ...
                            if (vendasChats.isEmpty) {
                              return EmptyChatsWidget(
                                firstString:
                                    'Nenhum chat de reserva está arquivado',
                                secondString:
                                    'Ao arquivar chats de vendas eles aparecerão aquia',
                              );
                            }
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 0.0, 0.0),
                                                                                child: Text(
                                                                                  containerAdsRecord.price.toString(),
                                                                                  style: FlutterFlowTheme.of(context).labelMedium.override(
                                                                                        fontFamily: 'Outfit',
                                                                                        color: Color(0xFFABABAB),
                                                                                        fontWeight: FontWeight.normal,
