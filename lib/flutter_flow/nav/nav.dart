        ...
        FFRoute(
          ...
          routes: [
            FFRoute(
              ...
              path: 'homePage',
              asyncParams: {
                'newAds': getDocList(['ads'], AdsRecord.fromSnapshot),
              },
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'homePage')
                  : HomePageWidget(
                      newAds: params.getParam<AdsRecord>(
                          'newAds', ParamType.Document, true),
                      testeArg: params.getParam('testeArg', ParamType.String),
                    ),
            ),
            FFRoute(
              name: 'loginSignup',
              ...
              builder: (context, params) => LoginSignupWidget(
                imagemTeste: params.getParam('imagemTeste', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'onboarding',
            ...
            FFRoute(
              ...
              path: 'adMain',
              asyncParams: {
                'adDocument': getDoc(['ads'], AdsRecord.fromSnapshot),
              },
              builder: (context, params) => AdMainWidget(
                adDocument: params.getParam('adDocument', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'createAd',
            ...
            FFRoute(
              name: 'chatPage_Seller',
              path: 'chatPageSeller',
              builder: (context, params) => ChatPageSellerWidget(
            ...
            FFRoute(
              name: 'chatPage_Buyer',
              path: 'chatPageBuyer',
              builder: (context, params) => ChatPageBuyerWidget(
                chatUser: params.getParam(
                    'chatUser', ParamType.DocumentReference, false, ['chats']),
                userRef: params.getParam(
                    'userRef', ParamType.DocumentReference, false, ['users']),
            ...
            FFRoute(
              ...
              builder: (context, params) => DownloadReportsWidget(),
            ),
            FFRoute(
              name: 'forgotPassword',
              path: 'forgotPassword',
